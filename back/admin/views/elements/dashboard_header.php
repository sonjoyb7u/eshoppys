...
<header class="main-header">
    ...
    <a href="../Page/dashboard.php" class="logo">
        ...
        <span class="logo-lg"><b>Admin -</b> BITM</span>
    </a>
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="<?php echo Utility::ADMIN_THEMES;?>dist/img/avatar5.png" class="user-image" alt="User Image">
                        <span class="hidden-xs">Welcome, <?php echo strtoupper(Session::get('username')); ?></span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- User image -->
                        <li class="user-header">
                            ...
                            <p>
                                <?= strtoupper(Session::get('username')); ?> - Web Developer
